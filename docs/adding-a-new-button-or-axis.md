...
!!! warning
    Be careful when _removing_ elements from the enums since EzInput can't know _which_ element you removed the IDs in the controller profiles might be shifted.
